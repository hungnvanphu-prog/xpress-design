...
export default function Home() {
  ...
  const projects = [
    {
      id: "1",
      src: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?q=80&w=1080",
      title: "Biệt Thự Vườn Tùng",
      type: "Kiến trúc & Nội thất",
    },
    {
      id: "2",
      src: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?q=80&w=1080",
      title: "Penthouse SkyFall",
      type: "Thiết kế Nội thất",
    },
    {
      id: "3",
      src: "https://images.unsplash.com/photo-1766603636562-531bb3e1dda8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBsdXh1cnklMjBob3VzZSUyMGV4dGVyaW9yJTIwYXJjaGl0ZWN0dXJlJTIwbWluaW1hbGlzdHxlbnwxfHx8fDE3NzYzNTE5MjN8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
      title: "Gallery House",
      type: "Cải tạo không gian",
    },
    {
      id: "4",
      src: "https://images.unsplash.com/photo-1600607686527-6fb886090705?q=80&w=1080",
      title: "Zen Retreat",
      type: "Kiến trúc cảnh quan",
    },
  ];
    ...
    <div className="w-full relative bg-[#F8F9FA] text-[#1A1A1A] font-['Montserrat',sans-serif]">
      ...
      <section className="py-24 md:py-40 bg-[#1A1A1A] text-white">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12">
          ...
          >
            <h2 className="font-['Playfair_Display',serif] text-[36px] md:text-[56px] leading-[1.1] font-medium max-w-2xl text-white">
              Những tác phẩm
              <br />
              mang dấu ấn XPRESS
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            {projects.map((project, index) => (
              <motion.div
                ...
                className={`group relative block w-full overflow-hidden ${index % 2 !== 0 ? "md:mt-32" : ""}`}
              >
                <Link
                  href={`/projects/${project.id}`}
                  className="block h-[500px] md:h-[700px] overflow-hidden"
                >
                  <img
                    src={project.src}
                    alt={project.title}
