...
import { getUrlSlugForLocale, serviceListingOrder } from '@/data/services';
            ...
            {SERVICE_CARD_KEYS.map((key, idx) => {
              ...
              >
                ...
                <div className="md:w-1/2 p-10 flex flex-col justify-between">
                  ...
                  <Link
                    href={`/services/${getUrlSlugForLocale(serviceListingOrder[idx], locale)}`}
                    className="flex items-center text-[#D4AF37] text-xs uppercase tracking-widest font-bold group/btn"
                  >
                    {tSvc('learnMore')}
